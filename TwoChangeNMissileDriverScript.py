...
while also changing both Blue's offensive missile success probability and salvo size.  
...
if __name__ == "__main__":
    ...
    fig.tight_layout()
    plt.savefig('BlueHitChangingBlueSuccessProbAndSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()    
    ...
    fig.tight_layout()
    plt.savefig('RedHitChangingBlueSuccessProbAndSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()  
    ...
    fig.tight_layout()
    plt.savefig('BothHitChangingBlueSuccessProbAndSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()  
    ...
    fig.tight_layout()
    plt.savefig('NoHitChangingBlueSuccessProbAndSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()  
    ...
    fig.tight_layout()
    plt.savefig('RangeChangingBlueSuccessProbAndSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()  
