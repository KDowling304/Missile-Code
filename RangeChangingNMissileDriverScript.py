...
multiple times while changes the range of the Blue ship's offensive missiles.  
...
if __name__ == "__main__":
    ...
    offensiveMissileRange = [0, 50, 100, 150, 200, 250, 300]
    ...
    for offRange in offensiveMissileRange:
    ...
    plt.plot(offensiveMissileRange, BlueShipHitPropArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, RedShipHitPropArr, color='red', label='Red')
    plt.plot(offensiveMissileRange, BothShipHitPropArr, color='black', label='Both')
    plt.plot(offensiveMissileRange, NoShipHitPropArr, color='green', label='Neither')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    ...
    plt.savefig('ProportionShipHitChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    
    #Graph of Number of Iterations Ship Hit
    plt.plot(offensiveMissileRange, BlueShipHitNumberArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, RedShipHitNumberArr, color='red', label='Red')
    plt.plot(offensiveMissileRange, BothShipHitNumberArr, color='black', label='Both')
    plt.plot(offensiveMissileRange, NoShipHitNumberArr, color='green', label='Neither')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average Number of Iterations Ship Hit')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number of Iterations Ship Hit of ' + str(iterations) + ' total Iterations\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Range Set at 300 NM)')
    plt.savefig('NumberShipHitChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
        
    
    #Graph of Average Range Between Ships
    plt.plot(offensiveMissileRange, AvgBlueOMRArr, color='blue', label='Blue Offensive Missile Range')
    plt.plot(offensiveMissileRange, AvgRedOMRArr, color='red', label='Red Offensive Missile Range')
    plt.plot(offensiveMissileRange, AvgRangeArr, color='black', label='Range Between Ships')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Range (NM)')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Range Between Ships at End of Simulation\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('RangeChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    
    #Graph of Average Missile Engagement Costs
    plt.plot(offensiveMissileRange, AvgBlueCostArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedCostArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Cost in USD')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Missile Engagement Cost\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)', pad=15)
    plt.savefig('CostChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Cost of Missiles Fired
    plt.plot(offensiveMissileRange, AvgBlueMissileCostArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedMissileCostArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Cost in USD')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Cost of Missiles Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)', pad=15)
    plt.savefig('MissileCostChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Offensive Missiles Fired
    plt.plot(offensiveMissileRange, AvgBlueOMFArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedOMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average Offensive Missiles Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number Offensive Missiles Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('OffensiveChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Defensive Missiles Fired
    plt.plot(offensiveMissileRange, AvgBlueDMFArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedDMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average Number Defensive Missiles Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Defensive Missiles Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('DefensiveChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average ESSMs Fired
    plt.plot(offensiveMissileRange, AvgBlueEMFArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedEMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average ESSMs Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number ESSMs Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('ESSMChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average SeaRAMs Fired
    plt.plot(offensiveMissileRange, AvgBlueSMFArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedSMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average SeaRAMs Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number SeaRAMs Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('SeaRAMChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average ESSMs Fired
    plt.plot(offensiveMissileRange, AvgBlueCMFArr, color='blue', label='Blue')
    plt.plot(offensiveMissileRange, AvgRedCMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Range (NM)')
    plt.ylabel('Average CIWS Iterations Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number CIWS Iterations Fired\nwhen Changing Blue Offensive Missile Range\n(Red Offensive Missile Range Set at 300 NM)')
    plt.savefig('CIWSChangingBlueRange.png', dpi=600, bbox_inches='tight')
    plt.show()
