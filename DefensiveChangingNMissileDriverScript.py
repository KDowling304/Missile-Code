...
while also changing both Blue's defensive missile salvo size.  
...
if __name__ == "__main__":
    ...
    defensiveMissileSalvoSize = list(range(1, sheet1['Defensive Missiles'][0] + 1))
    ...
    plt.plot(defensiveMissileSalvoSize, BlueShipHitPropArr, color='blue', label='Blue')
    ymin = min(BlueShipHitPropArr)
    xpos = BlueShipHitPropArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Blue: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            xy=(xmin, ymin), xycoords='data',
            xytext=(30, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, RedShipHitPropArr, color='red', label='Red')
    ymax = max(RedShipHitPropArr)
    xpos = RedShipHitPropArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Red: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            xy=(xmax, ymax), xycoords='data',
            xytext=(30, 10), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, BothShipHitPropArr, color='black', label='Both')
    ymin = min(BothShipHitPropArr)
    xpos = BothShipHitPropArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Both: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            xy=(xmin, ymin), xycoords='data',
            xytext=(30, 40), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, NoShipHitPropArr, color='green', label='Neither')
    ymax = max(NoShipHitPropArr)
    xpos = NoShipHitPropArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Neither: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            xy=(xmax, ymax), xycoords='data',
            xytext=(30, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.legend()
    plt.xlabel('Blue Defensive Missile Salvo Size')
    plt.ylabel('Proportion of Iterations Ship Hit')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Proportion of 1,000 Iterations Ship Hit\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)')
    plt.savefig('ProportionShipHitChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    
    #Graph of Number of Iterations Ship Hit
    plt.plot(defensiveMissileSalvoSize, BlueShipHitNumberArr, color='blue', label='Blue')
    plt.plot(defensiveMissileSalvoSize, RedShipHitNumberArr, color='red', label='Red')
    plt.plot(defensiveMissileSalvoSize, BothShipHitNumberArr, color='black', label='Both')
    plt.plot(defensiveMissileSalvoSize, NoShipHitNumberArr, color='green', label='Neither')
    plt.legend()
    plt.xlabel('Blue Defensive Missile Salvo Size')
    ...
    plt.savefig('NumberShipHitChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
        
    
    #Graph of Average Range Between Ships
    plt.plot(defensiveMissileSalvoSize, AvgBlueOMRArr, color='blue', label='Blue Offensive Missile Range')
    plt.plot(defensiveMissileSalvoSize, AvgRedOMRArr, color='red', label='Red Offensive Missile Range')
    plt.plot(defensiveMissileSalvoSize, AvgRangeArr, color='black', label='Range Between Ships')
    plt.legend()
    plt.xlabel('Blue Offensive Missile Salvo Size')
    plt.ylabel('Range (NM)')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Range Between Ships at End of Simulation\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)')
    plt.savefig('RangeChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    
    #Graph of Average Missile Engagement Costs
    plt.plot(defensiveMissileSalvoSize, AvgBlueCostArr, color='blue', label='Blue')
    ymin = min(AvgBlueCostArr)
    xpos = AvgBlueCostArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:,.2f}".format(ymin))
    label = "Min Blue: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgBlueCostArr)
    xpos = AvgBlueCostArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:,.2f}".format(ymax))
    label = "Max Blue: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            xy=(xmax, ymax), xycoords='data',
            xytext=(0, -40), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, AvgRedCostArr, color='red', label='Red')
    ymin = min(AvgRedCostArr)
    xpos = AvgRedCostArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:,.2f}".format(ymin))
    label = "Min Red: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            xy=(xmin, ymin), xycoords='data',
            xytext=(0, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgRedCostArr)
    xpos = AvgRedCostArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:,.2f}".format(ymax))
    label = "Max Red: (" + xlabel + ", $" + ylabel + ")"
    ...
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Missile Engagement Cost\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)', pad=15)
    plt.savefig('CostChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Cost of Missiles Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueMissileCostArr, color='blue', label='Blue')
    ymin = min(AvgBlueMissileCostArr)
    xpos = AvgBlueMissileCostArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:,.2f}".format(ymin))
    label = "Min Blue: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgBlueMissileCostArr)
    xpos = AvgBlueMissileCostArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:,.2f}".format(ymax))
    label = "Max Blue: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, AvgRedMissileCostArr, color='red', label='Red')
    ymin = min(AvgRedMissileCostArr)
    xpos = AvgRedMissileCostArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:,.2f}".format(ymin))
    label = "Min Red: (" + xlabel + ", $" + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgRedMissileCostArr)
    xpos = AvgRedMissileCostArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:,.2f}".format(ymax))
    label = "Max Red: (" + xlabel + ", $" + ylabel + ")"
    ...
    plt.savefig('MissileCostChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Offensive Missiles Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueOMFArr, color='blue', label='Blue')
    ymin = min(AvgBlueOMFArr)
    xpos = AvgBlueOMFArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Blue: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            xytext=(30, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgBlueOMFArr)
    xpos = AvgBlueOMFArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Blue: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, AvgRedOMFArr, color='red', label='Red')
    ymin = min(AvgRedOMFArr)
    xpos = AvgRedOMFArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Red: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            xytext=(30, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgRedOMFArr)
    xpos = AvgRedOMFArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Red: (" + xlabel + ", " + ylabel + ")"
    ...
    plt.savefig('OffensiveChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average Defensive Missiles Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueDMFArr, color='blue', label='Blue')
    ymin = min(AvgBlueDMFArr)
    xpos = AvgBlueDMFArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Blue: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgBlueDMFArr)
    xpos = AvgBlueDMFArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Blue: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            xytext=(30, -30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    plt.plot(defensiveMissileSalvoSize, AvgRedDMFArr, color='red', label='Red')
    ymin = min(AvgRedDMFArr)
    xpos = AvgRedDMFArr.index(ymin)
    xmin = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmin)
    ylabel = str("{:.2f}".format(ymin))
    label = "Min Red: (" + xlabel + ", " + ylabel + ")"
    plt.annotate(label,
            ...
            xytext=(30, 30), textcoords='offset points',
            arrowprops=dict(arrowstyle="->"))
    ymax = max(AvgRedDMFArr)
    xpos = AvgRedDMFArr.index(ymax)
    xmax = defensiveMissileSalvoSize[xpos]
    xlabel = str(xmax)
    ylabel = str("{:.2f}".format(ymax))
    label = "Max Red: (" + xlabel + ", " + ylabel + ")"
    ...
    plt.savefig('DefensiveChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average ESSMs Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueEMFArr, color='blue', label='Blue')
    plt.plot(defensiveMissileSalvoSize, AvgRedEMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Defensive Missile Salvo Size')
    plt.ylabel('Average ESSMs Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number ESSMs Fired\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)')
    plt.savefig('ESSMChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average SeaRAMs Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueSMFArr, color='blue', label='Blue')
    plt.plot(defensiveMissileSalvoSize, AvgRedSMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Defensive Missile Salvo Size')
    plt.ylabel('Average SeaRAMs Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number SeaRAMs Fired\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)')
    plt.savefig('SeaRAMChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
    
    #Graph of Average ESSMs Fired
    plt.plot(defensiveMissileSalvoSize, AvgBlueCMFArr, color='blue', label='Blue')
    plt.plot(defensiveMissileSalvoSize, AvgRedCMFArr, color='red', label='Red')
    plt.legend()
    plt.xlabel('Blue Defensive Missile Salvo Size')
    plt.ylabel('Average CIWS Iterations Fired')
    plt.locator_params(axis="x", integer=True, tight=True)
    plt.title('Average Number CIWS Iterations Fired\nwhen Changing Blue Defensive Missile Salvo Size\n(Red Defensive Missile Salvo Size Set at 2)')
    plt.savefig('CIWSChangingBlueDSalvoSize.png', dpi=600, bbox_inches='tight')
    plt.show()
